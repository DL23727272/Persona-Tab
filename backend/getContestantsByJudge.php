...
if (isset($_GET['judgeID'])) {
    ...
    if (count($categories) > 0) {
        $contestantsQuery = "
            SELECT c.idContestant, c.name, c.categoryID, c.contestantNo, c.gender, c.image
            FROM contestants c
        ...
        mysqli_stmt_bind_result($contestantsStmt, $contestantID, $name, $categoryID, $contestantNo, $gender, $image);
